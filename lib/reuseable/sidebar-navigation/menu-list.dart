...
class SidebarMenuList {
  ...
  Widget sidebarMenuList({String title, Color activeColor: Colors.blue, int index}) {
          ...
          child: ListTile(
            ...
            title: Transform(
              ...
              child: Text(title, style: TextStyle(
                fontSize: 14,
                color: !active? Colors.grey[500] : activeColor.withOpacity(.8),
              )),
            ),
            leading: Image.asset("assets/img/navigation/" + icon + ".png", width: 18),
          ),
        ),
      ),
    );
